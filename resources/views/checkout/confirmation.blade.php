...
<div class="max-w-xl mx-auto px-4 sm:px-6 py-12">
    <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-ink mb-2">Payment Successful!</h1>
    ...
    <div>
        <h2 class="text-base font-extrabold text-ink mb-3">
            {{ $tickets->count() === 1 ? 'Your Ticket' : 'Your Tickets' }}
        </h2>
        <div class="space-y-4">
                    ...
                    <div class="flex">
                        <div class="flex-1 p-5 min-w-0">
                            <div class="grid grid-cols-2 gap-3 mb-4">
                                <div>
                                    <p class="text-xs text-mute">Ticket Type</p>
                                ...
                                <div>
                                    <p class="text-xs text-mute">Ticket #</p>
                            ...
                            <div class="flex items-center gap-1.5 text-xs font-extrabold text-green-600">
                                ...
                                {{ strtoupper($ticket->status === 'valid' ? 'Valid' : $ticket->status) }}
                            </div>
                        </div>
